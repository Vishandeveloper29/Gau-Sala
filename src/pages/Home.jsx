    ...
    <div className="overflow-x-hidden bg-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-5">
        ...
        <div className="relative z-10 flex flex-col items-center text-center gap-6 max-w-4xl">
          <span className="bg-white/10 border border-white/20 text-white px-5 py-2 rounded-full text-sm backdrop-blur-md">
          ...
          <p className="text-gray-100 text-base sm:text-lg max-w-2xl leading-relaxed">
            Join Kam Denu Gaushala in our mission to rescue, rehabilitate,
            and provide a better future for rescued animals.
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full sm:w-auto">
            <button className="w-full sm:w-auto flex items-center justify-center gap-2 bg-amber-400 hover:bg-amber-300 px-8 py-3 rounded-full text-black font-semibold transition duration-300">
              Donate Now
              <Heart size={17} />
            </button>

            <button className="w-full sm:w-auto flex items-center justify-center gap-2 border-2 border-white text-white hover:bg-white hover:text-black px-8 py-3 rounded-full font-semibold transition duration-300">
              Emergency Help
            </button>
          </div>
        </div>
      ...
      <section className="relative z-20 -mt-12 px-5">
        <div className="max-w-7xl mx-auto bg-gray-100 rounded-[35px] p-5 sm:p-8 flex flex-wrap justify-center gap-5 shadow-xl">
          {stats.map((stat) => (
            <div
              key={stat.label}
              className="bg-white flex flex-col items-center justify-center gap-2 rounded-3xl shadow-md px-6 py-8 w-full sm:w-[45%] lg:w-[22%]"
            >
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12">
          <div className="w-full lg:w-1/2">
            <img
              src={ourmission}
              alt="Our Mission"
              className="w-full h-[350px] sm:h-[450px] object-cover rounded-[35px] shadow-lg"
            />
          </div>
          ...
          <div className="w-full lg:w-1/2 flex flex-col gap-5">
            ...
            <p className="text-gray-600 leading-8">
              At Kam Denu Gaushala, we believe every life is sacred.
              Our sanctuary provides a permanent, loving home for cows
              that have been abandoned, injured, or rescued from harsh conditions.
            </p>

            <button className="w-fit flex items-center gap-2 bg-green-700 hover:bg-green-800 px-6 py-3 rounded-full text-white font-semibold transition duration-300">
              Read More
              <MoveRight size={18} />
            </button>
          </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col items-center gap-12">
          <div className="text-center flex flex-col items-center gap-4 max-w-2xl">
            ...
            <p className="text-gray-500">
              Comprehensive care models designed for holistic well-being
              and sustainability.
            </p>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-6 w-full">
            {helpcards.map((item) => (
              <div
                key={item.title}
                className="bg-white rounded-3xl p-7 shadow-md hover:shadow-xl transition duration-300 w-full sm:w-[45%] lg:w-[23%] flex flex-col gap-4"
              >
      ...
      <section className="px-5 py-20">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12">
          <div className="w-full lg:w-1/2 flex flex-col gap-5">
            ...
            <p className="text-gray-600 leading-8">
              When Nandini arrived at our gates, she was severely
              malnourished and struggling to stand. Our dedicated
              medical team worked around the clock with care and patience.
            </p>

            <p className="text-gray-600 leading-8">
              Today, Nandini is the playful matriarch of her herd.
              Her transformation is a testament to compassion and professional care.
            </p>
          </div>
          ...
          <div className="w-full lg:w-1/2 flex flex-col sm:flex-row lg:flex-col gap-5">
            <img
              src={beforenandi}
              alt="Nandini before rescue"
              className="w-full sm:w-1/2 lg:w-full h-72 object-cover rounded-3xl shadow-md"
            />

            <img
              src={afternandi}
              alt="Nandini after rescue"
              className="w-full sm:w-1/2 lg:w-full h-72 object-cover rounded-3xl shadow-md"
            />
          </div>
        </div>
      ...
      <section className="px-5 py-20 bg-green-700">
        <div className="max-w-4xl mx-auto flex flex-col items-center text-center gap-6">
          ...
          <p className="text-green-100 leading-8 max-w-2xl">
            Your contribution directly funds medical supplies,
            high-quality fodder, and the expansion of our rescue
            operations. Every donation saves a life.
          </p>

          <button className="flex items-center gap-2 bg-amber-400 hover:bg-amber-300 text-black font-semibold py-3 px-7 rounded-full transition duration-300">
            Donate Now
            <HandHeart size={20} />
          </button>
        </div>
