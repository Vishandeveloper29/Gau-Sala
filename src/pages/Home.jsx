...
const Home = () => {
  ...
  return (
    <section className="overflow-x-hidden bg-white">
      ...
      <section
        className="relative min-h-screen flex items-center justify-center bg-cover bg-center bg-no-repeat px-5"
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12">
          <div className="w-full lg:w-1/2">
            <img
              src={ourmission}
              alt="Our Mission"
              className="w-full h-[330px] sm:h-[430px] object-cover rounded-[35px] shadow-lg"
            />
          </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col items-center gap-12">
          ...
          <div className="flex flex-wrap justify-center gap-6 w-full">
            {helpcards.map((item) => (
              <div
                key={item.title}
                className="bg-white rounded-3xl p-7 shadow-md hover:shadow-xl transition w-full sm:w-[45%] lg:w-[23%] flex flex-col gap-4"
              >
